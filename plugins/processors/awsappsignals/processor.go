...
func (ap *awsappsignalsprocessor) processMetrics(ctx context.Context, md pmetric.Metrics) (pmetric.Metrics, error) {
	...
	for i := 0; i < rms.Len(); i++ {
		...
		ap.logger.Info("8-3-4-0 DEBUG: ", zap.Any("Max: ", ilms.At(0).Metrics().At(0).ExponentialHistogram().DataPoints().At(0).Max()))
		ap.logger.Info("8-3-4-0 DEBUG: ", zap.Any("Min: ", ilms.At(0).Metrics().At(0).ExponentialHistogram().DataPoints().At(0).Min()))
		ap.logger.Info("8-3-4-0 DEBUG: ", zap.Any("Start Timestamp: ", ilms.At(0).Metrics().At(0).ExponentialHistogram().DataPoints().At(0).StartTimestamp()))
		ap.logger.Info("8-3-4-0 DEBUG: ", zap.Any("Sum: ", ilms.At(0).Metrics().At(0).ExponentialHistogram().DataPoints().At(0).Sum()))
		ap.logger.Info("8-3-4-0 DEBUG: ", zap.Any("Scale:  ", ilms.At(0).Metrics().At(0).ExponentialHistogram().DataPoints().At(0).Scale()))
		...
		ap.logger.Info("8-3-4-1 DEBUG: ", zap.Any("Max: ", ilms.At(0).Metrics().At(1).ExponentialHistogram().DataPoints().At(0).Max()))
		ap.logger.Info("8-3-4-1 DEBUG: ", zap.Any("Min: ", ilms.At(0).Metrics().At(1).ExponentialHistogram().DataPoints().At(0).Min()))
		ap.logger.Info("8-3-4-1 DEBUG: ", zap.Any("Start Timestamp: ", ilms.At(0).Metrics().At(1).ExponentialHistogram().DataPoints().At(0).StartTimestamp()))
		ap.logger.Info("8-3-4-1 DEBUG: ", zap.Any("Sum: ", ilms.At(0).Metrics().At(1).ExponentialHistogram().DataPoints().At(0).Sum()))
		ap.logger.Info("8-3-4-1 DEBUG: ", zap.Any("Scale:  ", ilms.At(0).Metrics().At(1).ExponentialHistogram().DataPoints().At(0).Scale()))

		ap.logger.Info("8-3-1-2 DEBUG: ", zap.Any("Metric Name: ", ilms.At(0).Metrics().At(2).Name()))
		ap.logger.Info("8-3-2-2 DEBUG: ", zap.Any("Metric Unit ", ilms.At(0).Metrics().At(2).Unit()))
		ap.logger.Info("8-3-3-2 DEBUG: ", zap.Any("Metric Type ", ilms.At(0).Metrics().At(2).Type()))
		ap.logger.Info("8-3-4-2 DEBUG: ", zap.Any("Metric's Exponential Hist: ", ilms.At(0).Metrics().At(2).ExponentialHistogram()))
		ap.logger.Info("8-3-4-2 DEBUG: ", zap.Any("Max: ", ilms.At(0).Metrics().At(2).ExponentialHistogram().DataPoints().At(0).Max()))
		ap.logger.Info("8-3-4-2 DEBUG: ", zap.Any("Min: ", ilms.At(0).Metrics().At(2).ExponentialHistogram().DataPoints().At(0).Min()))
		ap.logger.Info("8-3-4-2 DEBUG: ", zap.Any("Start Timestamp: ", ilms.At(0).Metrics().At(2).ExponentialHistogram().DataPoints().At(0).StartTimestamp()))
		ap.logger.Info("8-3-4-2 DEBUG: ", zap.Any("Sum: ", ilms.At(0).Metrics().At(2).ExponentialHistogram().DataPoints().At(0).Sum()))
		ap.logger.Info("8-3-4-2 DEBUG: ", zap.Any("Scale:  ", ilms.At(0).Metrics().At(2).ExponentialHistogram().DataPoints().At(0).Scale()))

		ap.logger.Info("8-3-4-2 DEBUG: ", zap.Any("Metric's Exponential Hist: ", ilms.At(0).Metrics().At(2).ExponentialHistogram().DataPoints().Len()))
