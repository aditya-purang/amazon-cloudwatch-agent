...
func (ap *awsappsignalsprocessor) processMetrics(ctx context.Context, md pmetric.Metrics) (pmetric.Metrics, error) {
	...
	for i := 0; i < rms.Len(); i++ {
		...
		ap.logger.Info("8-3-1 DEBUG: ", zap.Any("Metric Name: ", ilms.At(0).Metrics().At(0).Name()))
		ap.logger.Info("8-3-2 DEBUG: ", zap.Any("Metric Unit ", ilms.At(0).Metrics().At(0).Unit()))
		ap.logger.Info("8-3-3 DEBUG: ", zap.Any("Metric Type ", ilms.At(0).Metrics().At(0).Type()))
		ap.logger.Info("8-3-4 DEBUG: ", zap.Any("Metric's Exponential Hist: ", ilms.At(0).Metrics().At(0).ExponentialHistogram()))
		ap.logger.Info("8-3-1 DEBUG: ", zap.Any("Metric Name: ", ilms.At(0).Metrics().At(1).Name()))
		ap.logger.Info("8-3-2 DEBUG: ", zap.Any("Metric Unit ", ilms.At(0).Metrics().At(1).Unit()))
		ap.logger.Info("8-3-3 DEBUG: ", zap.Any("Metric Type ", ilms.At(0).Metrics().At(1).Type()))
		ap.logger.Info("8-3-4 DEBUG: ", zap.Any("Metric's Exponential Hist: ", ilms.At(0).Metrics().At(1).ExponentialHistogram()))
		ap.logger.Info("8-3-5 DEBUG: ", zap.Any("Metric Summary ", ilms.At(0).Metrics().At(1).Summary()))
		ap.logger.Info("8-3-6 DEBUG: ", zap.Any("Metric Gauge ", ilms.At(0).Metrics().At(1).Gauge()))
		ap.logger.Info("8-3-7 DEBUG: ", zap.Any("Metric Sum ", ilms.At(0).Metrics().At(1).Sum()))
		ap.logger.Info("8-3-8 DEBUG: ", zap.Any("Metric Histogram ", ilms.At(0).Metrics().At(1).Histogram()))
		ap.logger.Info("8-3-9 DEBUG: ", zap.Any("Metric Description ", ilms.At(0).Metrics().At(1).Description()))

		ap.logger.Info("8-3-1 DEBUG: ", zap.Any("Metric Name: ", ilms.At(0).Metrics().At(2).Name()))
		ap.logger.Info("8-3-2 DEBUG: ", zap.Any("Metric Unit ", ilms.At(0).Metrics().At(2).Unit()))
		ap.logger.Info("8-3-3 DEBUG: ", zap.Any("Metric Type ", ilms.At(0).Metrics().At(2).Type()))
		ap.logger.Info("8-3-4 DEBUG: ", zap.Any("Metric's Exponential Hist: ", ilms.At(0).Metrics().At(2).ExponentialHistogram()))
		ap.logger.Info("8-3-5 DEBUG: ", zap.Any("Metric Summary ", ilms.At(0).Metrics().At(2).Summary()))
		ap.logger.Info("8-3-6 DEBUG: ", zap.Any("Metric Gauge ", ilms.At(0).Metrics().At(2).Gauge()))
		ap.logger.Info("8-3-7 DEBUG: ", zap.Any("Metric Sum ", ilms.At(0).Metrics().At(2).Sum()))
		ap.logger.Info("8-3-8 DEBUG: ", zap.Any("Metric Histogram ", ilms.At(0).Metrics().At(2).Histogram()))
		ap.logger.Info("8-3-9 DEBUG: ", zap.Any("Metric Description ", ilms.At(0).Metrics().At(2).Description()))
